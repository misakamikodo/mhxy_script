...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label_2.setGeometry(QtCore.QRect(690, 390, 91, 20))
        self.label_2.setAlignment(QtCore.Qt.AlignmentFlag.AlignRight|QtCore.Qt.AlignmentFlag.AlignTrailing|QtCore.Qt.AlignmentFlag.AlignVCenter)
        self.label_2.setObjectName("label_2")
        self.tabWidget = QtWidgets.QTabWidget(parent=self.centralwidget)
        self.tabWidget.setGeometry(QtCore.QRect(10, 10, 591, 411))
        ...
        self.line_4 = QtWidgets.QFrame(parent=self.utilTab)
        self.line_4.setGeometry(QtCore.QRect(0, 40, 31, 191))
        self.line_4.setFrameShape(QtWidgets.QFrame.Shape.VLine)
        self.line_4.setFrameShadow(QtWidgets.QFrame.Shadow.Sunken)
        self.line_4.setObjectName("line_4")
        self.batch_tool_btn = QtWidgets.QPushButton(parent=self.utilTab)
        self.batch_tool_btn.setGeometry(QtCore.QRect(10, 10, 111, 31))
        self.batch_tool_btn.setObjectName("batch_tool_btn")
        self.shopping2_btn = QtWidgets.QPushButton(parent=self.utilTab)
        self.shopping2_btn.setGeometry(QtCore.QRect(40, 90, 75, 23))
        self.shopping2_btn.setObjectName("shopping2_btn")
        self.mine_chk = QtWidgets.QCheckBox(parent=self.utilTab)
        self.mine_chk.setGeometry(QtCore.QRect(20, 170, 21, 16))
        self.mine_chk.setText("")
        self.mine_chk.setObjectName("mine_chk")
        self.mine_btn = QtWidgets.QPushButton(parent=self.utilTab)
        self.mine_btn.setGeometry(QtCore.QRect(40, 170, 75, 23))
        self.mine_btn.setObjectName("mine_btn")
        self.shopping1_btn = QtWidgets.QPushButton(parent=self.utilTab)
        self.shopping1_btn.setGeometry(QtCore.QRect(40, 50, 75, 23))
        self.shopping1_btn.setObjectName("shopping1_btn")
        self.shopping3_btn = QtWidgets.QPushButton(parent=self.utilTab)
        self.shopping3_btn.setGeometry(QtCore.QRect(40, 130, 75, 23))
        self.shopping3_btn.setObjectName("shopping3_btn")
        self.shopping2_txt = QtWidgets.QLabel(parent=self.utilTab)
        self.shopping2_txt.setGeometry(QtCore.QRect(120, 90, 111, 21))
        self.shopping2_txt.setObjectName("shopping2_txt")
        self.shopping3_txt = QtWidgets.QLabel(parent=self.utilTab)
        self.shopping3_txt.setGeometry(QtCore.QRect(120, 125, 121, 31))
        self.shopping3_txt.setObjectName("shopping3_txt")
        self.tool_shutdown_chk = QtWidgets.QCheckBox(parent=self.utilTab)
        self.tool_shutdown_chk.setGeometry(QtCore.QRect(20, 210, 111, 16))
        self.tool_shutdown_chk.setObjectName("tool_shutdown_chk")
        self.bangpai2_btn = QtWidgets.QPushButton(parent=self.utilTab)
        self.bangpai2_btn.setGeometry(QtCore.QRect(30, 240, 75, 23))
        self.bangpai2_btn.setObjectName("bangpai2_btn")
        self.shopping1_txt = QtWidgets.QLabel(parent=self.utilTab)
        self.shopping1_txt.setGeometry(QtCore.QRect(120, 40, 361, 41))
        self.shopping1_txt.setObjectName("shopping1_txt")
        self.bangpai2_cfg_btn = QtWidgets.QToolButton(parent=self.utilTab)
        self.bangpai2_cfg_btn.setGeometry(QtCore.QRect(110, 240, 37, 18))
        self.bangpai2_cfg_btn.setObjectName("bangpai2_cfg_btn")
        self.groupBox_2 = QtWidgets.QGroupBox(parent=self.utilTab)
        self.groupBox_2.setGeometry(QtCore.QRect(20, 50, 31, 121))
        self.groupBox_2.setTitle("")
        self.groupBox_2.setObjectName("groupBox_2")
        self.shopping1_rdo = QtWidgets.QRadioButton(parent=self.groupBox_2)
        self.shopping1_rdo.setGeometry(QtCore.QRect(0, 0, 16, 16))
        self.shopping1_rdo.setText("")
        self.shopping1_rdo.setObjectName("shopping1_rdo")
        self.shopping2_rdo = QtWidgets.QRadioButton(parent=self.groupBox_2)
        self.shopping2_rdo.setGeometry(QtCore.QRect(0, 40, 16, 16))
        self.shopping2_rdo.setText("")
        self.shopping2_rdo.setObjectName("shopping2_rdo")
        self.shopping3_rdo = QtWidgets.QRadioButton(parent=self.groupBox_2)
        self.shopping3_rdo.setGeometry(QtCore.QRect(0, 80, 16, 16))
        self.shopping3_rdo.setText("")
        self.shopping3_rdo.setObjectName("shopping3_rdo")
        self.tabWidget.addTab(self.utilTab, "")
        self.game_process_small_btn = QtWidgets.QPushButton(parent=self.centralwidget)
        self.game_process_small_btn.setGeometry(QtCore.QRect(620, 10, 75, 23))
        ...
        self.game_process_origin_btn.setGeometry(QtCore.QRect(710, 10, 75, 23))
        self.game_process_origin_btn.setObjectName("game_process_origin_btn")
        self.groupBox = QtWidgets.QGroupBox(parent=self.centralwidget)
        self.groupBox.setGeometry(QtCore.QRect(620, 280, 161, 71))
        self.groupBox.setTitle("")
        self.groupBox.setObjectName("groupBox")
        self.target_right_rdo = QtWidgets.QRadioButton(parent=self.groupBox)
        self.target_right_rdo.setGeometry(QtCore.QRect(80, 40, 89, 16))
        self.target_right_rdo.setObjectName("target_right_rdo")
        self.target_left_rdo = QtWidgets.QRadioButton(parent=self.groupBox)
        self.target_left_rdo.setGeometry(QtCore.QRect(80, 10, 89, 16))
        self.target_left_rdo.setChecked(True)
        self.target_left_rdo.setObjectName("target_left_rdo")
        ...
        self.log_btn.setGeometry(QtCore.QRect(700, 360, 75, 23))
        self.log_btn.setObjectName("log_btn")
        self.listWidget = QtWidgets.QListWidget(parent=self.centralwidget)
        self.listWidget.setGeometry(QtCore.QRect(620, 70, 161, 171))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.batch_tool_btn.setText(_translate("MainWindow", "一键顺序执行"))
        ...
        self.tool_shutdown_chk.setText(_translate("MainWindow", "完成后自动关机"))
        self.bangpai2_btn.setText(_translate("MainWindow", "帮派任务"))
        self.shopping1_txt.setText(_translate("MainWindow", "自行设计mhxy_shopping.py脚本细节，否则为500法宝碎片"))
        ...
        self.target_right_rdo.setText(_translate("MainWindow", "右下窗口"))
        self.target_left_rdo.setText(_translate("MainWindow", "左上窗口"))
