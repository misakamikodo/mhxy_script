...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label = QtWidgets.QLabel(parent=self.richangTab1)
        ...
        self.label_9.setGeometry(QtCore.QRect(130, 70, 331, 21))
        ...
        self.bangpai_btn = QtWidgets.QPushButton(parent=self.utilTab)
        self.bangpai_btn.setGeometry(QtCore.QRect(10, 15, 75, 23))
        self.bangpai_btn.setObjectName("bangpai_btn")
        self.bangpai_cfg_btn = QtWidgets.QToolButton(parent=self.utilTab)
        self.bangpai_cfg_btn.setGeometry(QtCore.QRect(90, 15, 37, 18))
        self.bangpai_cfg_btn.setObjectName("bangpai_cfg_btn")
        self.auto_battle_btn = QtWidgets.QPushButton(parent=self.utilTab)
        self.auto_battle_btn.setGeometry(QtCore.QRect(10, 110, 75, 23))
        self.auto_battle_btn.setObjectName("auto_battle_btn")
        self.groupBox_2 = QtWidgets.QGroupBox(parent=self.utilTab)
        self.groupBox_2.setGeometry(QtCore.QRect(100, 100, 311, 41))
        ...
        self.groupBox_4.setGeometry(QtCore.QRect(10, 160, 411, 51))
        ...
        self.linlongshi_btn.setGeometry(QtCore.QRect(10, 60, 141, 21))
        self.linlongshi_btn.setObjectName("linlongshi_btn")
        self.linlongshi_cfg_btn = QtWidgets.QToolButton(parent=self.utilTab)
        self.linlongshi_cfg_btn.setGeometry(QtCore.QRect(170, 60, 37, 18))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(_translate("MainWindow", "多选20秒开启下一个，需要关闭小黑窗防止遮挡。"))
        ...
        self.label_9.setText(_translate("MainWindow", "通常不需要勾选第一个副本，因为一般开始位置已经进去了"))
        ...
        self.bangpai_btn.setText(_translate("MainWindow", "帮派任务"))
        self.bangpai_cfg_btn.setText(_translate("MainWindow", "配置"))
        ...
        self.label_6.setText(_translate("MainWindow", "多选一般\n"
"逐个执行"))
