...
from win.linlongshi_config import Ui_Dialog


class LinlongshiCfgDialog(QDialog, Ui_Dialog):
    def __init__(self):
        super(LinlongshiCfgDialog, self).__init__()
        self.setupUi(self)
        self.pushButton_4.clicked.connect(self.save)
        self.file_path = os.path.join(os.path.abspath('.'), r'resources\linlongshi\linlongshi.ini')
