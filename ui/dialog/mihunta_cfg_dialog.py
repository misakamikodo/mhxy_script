...
class MihuntaCfgDialog(QDialog, Ui_dialog):
    def __init__(self):
        super(MihuntaCfgDialog, self).__init__()
        self.setupUi(self)
        self.pushButton_4.clicked.connect(self.save)
        self.file_path = os.path.join(os.path.abspath('.'), r'resources\mihunta\mihunta.ini')
